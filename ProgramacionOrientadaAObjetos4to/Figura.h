...
{
public:
	// Si una función es virtual en alguna clase ancestra, entonces siempre va a ser virtual dicha función,
	...
	// Cubo.CalcularArea() todavía puede hacer override a pesar de que en Cuadrado no está explícitamente como virtual.
	// En resumen: Una vez virtual, por siempre será virtual.
...
public:
	...
	{
		// Los bloques try-throw-catch son súper comúnes en cosas de web, como servidores.
		try
		{
			if (numLados < 3)
			{
